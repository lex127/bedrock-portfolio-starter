...
if (in_array(strtolower($category), [ 'uncategorized', 'без рубрики', 'uncategorized-en', 'uncategorized-ru' ], true)) {
			...
			<div class="post-hero">
				...
				<?php if (has_post_thumbnail()) : ?>
					<div class="post-hero__media">
						<?php echo get_the_post_thumbnail($post_id, 'large', [ 'loading' => 'eager', 'itemprop' => 'image' ]); ?>
					</div>
				<?php endif; ?>
			</div>
		</header>
